...
yShiftTable:	.byte 0<<5,1<<5,2<<5,3<<5,4<<5,5<<5,6<<5,7<<5
...
Objs1PosXLo:
	.fill NUM_OBJS1, i * 5
Objs1PosYLo:
	.fill NUM_OBJS1, 16	//mod((i * 10), SCREEN_HEIGHT-16)
Objs1VelX:
...
Objs2PosXLo:
	.fill NUM_OBJS2, i * 5
Objs2PosYLo:
	.fill NUM_OBJS2, 24	//mod((i * 10), SCREEN_HEIGHT-16)
Objs2VelX:
...
Objs3PosXLo:
	.fill NUM_OBJS2, i * 8
Objs3PosYLo:
	.fill NUM_OBJS2, 32	//mod((i * 10), SCREEN_HEIGHT-16)
Objs3VelX:
